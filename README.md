...
|----------|-------------|------|
| Project Explainer (2 min 15 sec) | Overview of the architecture and safety certificates | <a href="https://youtu.be/aqhGXsX5nPA" target="_blank">Watch</a> |
...
A 2 minute 15 second overview of the project, the architecture, and the safety certificate framework.
